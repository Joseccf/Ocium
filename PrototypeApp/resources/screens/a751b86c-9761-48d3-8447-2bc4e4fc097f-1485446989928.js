jQuery("#simulation")
  .on("click", ".s-a751b86c-9761-48d3-8447-2bc4e4fc097f .click", function(event, data) {
    ...
    if(jFirer.is("#s-Label_36")) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Label_19": {
                      "attributes": {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Two-line-item_11")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Label_20": {
                      "attributes": {
                        "background-color": "#FFFD38",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Label_21": {
                      "attributes": {
                        "background-color": "#FFFD38",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Rectangle_7": {
                      "attributes": {
                        "line-height": "26px",
                        "font-size": "12.0pt",
                    ...
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Rectangle_7 .valign": {
                      "attributes": {
                        "vertical-align": "top",
                        "text-align": "left"
                      }
                    ...
                    "#s-a751b86c-9761-48d3-8447-2bc4e4fc097f #s-Rectangle_7 span": {
                      "attributes": {
                        "color": "#02BBD2",
                        "text-align": "left",
